...
<script type="text/javascript">
  ...
  amplitude.getInstance().init("041c9929021a51a2b89c68a428a39393");
    ...
    <link href="<?php echo e(url('/')); ?>/back/css/fontawesome-all.css" rel="stylesheet">
    <link href="<?php echo e(url('/')); ?>/back/css/bootstrap.css" rel="stylesheet" type="text/css" />


   <!-- <link href="<?php echo e(url('/')); ?>/back/css/custom.css" rel="stylesheet" type="text/css" /> 
 -->
   <link href="<?php echo e(url('/')); ?>/back/css/custom.min.css" rel="stylesheet" type="text/css" /> 

   <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/back/css/jquery.dataTables.css">
