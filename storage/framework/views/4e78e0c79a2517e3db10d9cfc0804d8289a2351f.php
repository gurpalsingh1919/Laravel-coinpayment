      ...
      <a  href="<?php echo e(url('/dashboard')); ?>"><i></i>Buy Kwatts</a></li>
       ...
       <li class="<?php echo e(Request::is('withdraw')?'active':''); ?>">
		...
		?>
             ...
             <!--  <a href="<?php echo e(url('/user-promo')); ?>"><i class="fas fa-tag"></i>Promotional Materials</a> -->
              <a href="<?php echo e(url('/user-promo')); ?>"><i class="fas fa-tag"></i>Affiliate Promotion</a>
    ...
    <div class="page">
        <nav class="navbar navbar-expand-lg navbar-light bg-dark justify-content-between">
               ...
               <div class="kwat_ern_bx">
                <a href="<?php echo e(url('/dashboard')); ?>"><h3 class="mb-3 mt-3 header-text" >BUY KWATTS NOW TO EARN 25% MATCHING BONUS </h3></a>
               <!--  <span class="matching_bonus_link">Copy Your Affiliate Link Here To Share 4NEW With Friends <p><?php echo e(Sentinel::getuser()->ref_token); ?></p> <input type="hidden" class="form-control" id="post-reflink" value="<?php echo e(url('aff')); ?>?ref=<?php echo e(Sentinel::getuser()->ref_token); ?>&page=home">
