      ...
      <div id="qrModal" class="modal modal-styled fade in modals-body ">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form id="gauth-form1" inspfaactive="true" action="<?php echo e(url('2fa/save')); ?>" method="post" class="">
...
When you enable 2-Factor Authentication (also known as 2-step authentication), you add an extra layer of security to your account. You sign in with something you know (your password) and something you have (a code sent to your smartphone). Get the Google Authenticator. Google authenticator is free and available in the app store for your device.</code>
      ...
      <div id="qrmatch" class="modal modal-styled fade in modals-body">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form id="gauth-form2" class=" theme-form" inspfaactive="true" action="<?php echo e(url('2fa/disable')); ?>" method="get">
              <div class="modal-body">
    ...
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/back/js/popper.min.js"></script>
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/back/js/bootstrap.js"></script>

    <script type="text/javascript" src="<?php echo e(url('/')); ?>/back/js/bootstrap.bundle.js"></script>
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/back/js/main.js"></script>
    <!--end::Base Scripts -->
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.js"></script>
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/responsive/2.2.1/js/dataTables.responsive.min.js"></script>

    <script src="<?php echo e(url('/')); ?>/back/js/sweetalert2.js"></script>
    <script src="<?php echo e(url('/')); ?>/back/js/sweetalert2.all.js"></script>
     <script src="<?php echo e(url('/')); ?>/back/js/ajax.js"></script>
     <!--  <script src="<?php echo e(url('/')); ?>/back/js/ajax.min.js"></script> -->


<div class="telegram"><p><a href="https://t.me/FRNCoin" target="_blank"><img src="<?php echo e(url('/')); ?>/back/images/telegram.png"></a></p></div>
