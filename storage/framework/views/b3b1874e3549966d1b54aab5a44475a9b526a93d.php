<?php echo $__env->make('emails.layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<tr>
      <td colspan="2"><img src="<?php echo e(url('/')); ?>/images/email/congratulation.png"  alt="" style="width:100%;"/></td>
    </tr>
    <tr>
      <td colspan="2"></td>
    </tr>
    <tr>
      <td colspan="2" style="background:url(<?php echo e(url('/images/email/bgback_new.png')); ?>)0 0 no-repeat"><!-- <h4 style="font-size:36px; margin:0; padding:15px 0; color:#7dc242; font-weight:600;"><?php echo e($user->fullname); ?></h4> -->
        <p style=" color:#5f5f5f; font-size:16px; font-weight:400; padding:0 10px; box-sizing:border-box;"><h2>Please Confirm Your Account</h2></p>
          <p style=" color:#5f5f5f; font-size:16px; font-weight:400; padding:25px 10px; box-sizing:border-box;text-align: left;">
            Congratulations <?php echo e($user->fullname); ?>, your account has been successfully created. <br/>
            You can now login by pressing the green Confirm Account button below.<br/><br/><br/>

            CONFIRM ACCOUNT  <<< <a href="<?php echo e($link); ?>" style=" background:#7dc242; color:#fff; font-size:14px; margin-bottom:35px; padding:10px 10px; display:inline-block; text-decoration:none; text-transform:uppercase;">Confirm Account </a><br/>
