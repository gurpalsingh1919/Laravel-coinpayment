  ...
  <div class="col">
    <div class="">
       <div class="mb-5 col-lg-12 kwat_ern_bx dash-ref-user-link copyafilate_pge">
         <span class="matching_bonus_link">Copy Your Affiliate Link Here To Share 4NEW With Friends</span> <p><input type="text" class="ref-input" id="post-reflink" value="<?php echo e(url('aff')); ?>?ref=<?php echo e(Sentinel::getuser()->ref_token); ?>&page=home" readonly="">
...
<form id="master-card-payment" action="<?php echo e(url('/master-card-payment')); ?>" method="get" 
name="paypalform">
         <!--   <?php echo e(csrf_field()); ?> -->
...
<div id="welcomemessage" class="modal modal-styled fade in modals-body">
          ...
          <div class="modal-content">
            ...
            <div class="logged_succcefuly">
             <span id="succfl_chck"><img src="<?php echo e(url('/')); ?>/assets/images/check.png" width="20" height="20"></span>
              <h4 class="text-center w-100">Welcome  <?php echo e(Sentinel::getUser()->fullname); ?></h4>
              ...
              <div class="modal-body theme-form">
                ...
                <div class="text-center">
                 <div class="support_dev">
                  ...
                  <?php if(session('air_drop')==1): ?>
                    $20*
                  <?php elseif(session('air_drop')==11): ?>
                    $22*
                  <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if(session('paymentsuccess')==1): ?>
        <script>
...
function register_click()
{
    ...
    if( user_email !='')
    {
        try 
        {
            ...
            'order_id': '<?php echo e($user->email); ?>', });
        }
        catch(err) 
        {
            console.log(err);
