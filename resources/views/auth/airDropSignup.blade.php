                ...
                <!--begin::Portlet-->
                    <div class="right-login register_update">
                        ...
                        <h3 class="form-title text-center">
                            To Claim Your FREE 4NEW KWATT Token AirDrop Worth
                             @if(Request::segment(1)=='signup')
                             $20 
                             @elseif(Request::segment(1)=='signup1')
                             $22
                             @endif
                             , Register Here
                        </h3>
                        ...
                        <form id="register-form" action="{{ url('register') }}" method="post" class="tab-content active">
                            ...
                            <div class="form-group form-row">
                             ...
                             @if(Request::segment(1)=='signup')
                             <input type="hidden" name="air_drop" value="1">
                             @elseif(Request::segment(1)=='signup1')
                            <input type="hidden" name="air_drop" value="11">
                             @endif
