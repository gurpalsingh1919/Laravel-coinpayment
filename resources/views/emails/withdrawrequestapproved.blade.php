@include('emails.layout.header')
    <tr>
      <td colspan="2"><img src="{{ url('/') }}/images/email/Withdraw.jpg"  alt="" style="width:100%;"/></td>
    </tr>
    ...
    <tr>
      ...
      Your Withdrawal Request of <strong>{{ $amount_withdraw }} {{ $coin_name }} </strong> has been approved by the designated admin at 4NEW. Please see the txid for the remittance to you. 
