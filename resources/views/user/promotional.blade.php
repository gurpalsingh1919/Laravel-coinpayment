...
<script type="text/javascript" src="{{ url('/') }}/back/js/video_aff.js"></script>
<!-- <script type="text/javascript" src="{{ url('/') }}/back/js/watch_video.js"></script> -->
   ...
   <!--    <div class="col-lg-12 mb-5">
          <div class="card">
            <div class="card-body p-5 text-center welcome-affiliate">
              ...
              For Affiliate Contest Details <a href="{{ url('/user-referral') }}"><strong>CLICK HERE</strong></a>.
              <br/>
              <br/>
      ...
      <div class="card-header">
        <h5 class="text-uppercase text-center mb-0">REFER A FRIEND & EARN 25% MATCHING BONUS ON KWATTS PURCHASED</h5>
      </div>
                  ...
                  <div class="cardcustombordr mb-2">
                    <div class="card-body mt-4 pr-3 pl-3 pt-1 pb-4">
                      ...
                      <div class="social-ics shar-icons">
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{url('aff')}}?ref={{ Sentinel::getuser()->ref_token }}" class="fab fa-facebook-f" data-href="{{url('aff')}}?ref={{ Sentinel::getuser()->ref_token }}" target="_blank"></a>
...
Graphic should be the Help Save The Planet banner&amp;url={{url('aff')}}?ref={{ Sentinel::getuser()->ref_token }}" class="fab fa-twitter" target="_blank"></a>
                        
                        <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{url('aff')}}?ref={{ Sentinel::getuser()->ref_token }}&amp;title=Help Save The Planet With KWATT Tokenized Electricity.  4NEW is the World's first company to use waste to create energy to power Crypto-Mining.  Patent Pending process! Graphic should be the Help Save The Planet banner" class="fab fa-linkedin-in" target="_blank"></a>
                  ...
                  <div class="col-lg-12">
                    ...
                    <form class="form-copy theme-form">
                      <div class="input-group">
                        <input type="text" class="form-control" id="post-sharelink" value="{{url('aff')}}?ref={{ Sentinel::getuser()->ref_token }}&page=home">
                    ...
                    <form class="form-copy theme-form">
                      <div class="input-group">
                        <input type="text" class="form-control" id="post-sharelink-affiliate" value="{{url('aff')}}?ref={{ Sentinel::getuser()->ref_token }}&page=affiliate">
                          <span class="input-group-btn">
                    ...
                    <div class="col-lg-12">
                      <label>Most Recent 4NEW Webinar :</label>
                    <form class="form-copy theme-form">
                      <div class="input-group">
                        <input type="text" class="form-control" id="post-webinar-affiliate" value="{{url('aff')}}?ref={{ Sentinel::getuser()->ref_token }}&page=webinar">
                          <span class="input-group-btn">
                            <button class="btn btn-secondary" id="copy-button" data-clipboard-target="#post-webinar-affiliate" type="button" onclick="copyWebinarlink()" >copy</button>
                          </span>
                        </div>
                      </form>
                    </div>
...
<div class="card mb-5 mt-5">
                      ...
                      <div class="card-body pr-4 pb-2 mt-2">
                            ...
                            <ul class="step_section">
                              <li>Who do you know that may be interested in 4NEW?  Email them NOW to leverage the 25% MATCH BONUS.</li>
                              <!-- <li><strong>From:</strong> {{Sentinel::getuser()->fullname }}<br/></li>
 ...
 -->
         ...
         <strong>Success : </strong>   {{ session('success') }}
                        ...
                        <div class="from-group mb-2">
                          ...
                          <span><span class=" text-danger">{{ $errors->first('username') }}</span> <br></span>
                        </div>
                        <div class="from-group mb-2">
                          <label>To</label>
...
<div class="col-lg-6">
              <div class="card mb-5">
                  ...
                  <br/>
                      <div class="pr-4 pb-2">
                        <div class="ref-code-container">
                          <img src="{{ url('/') }}/back/images/advertisement-1.jpg">
                          </div>
                            ...
                            <div class="col-lg-6">
                              <div class="from-group">
                                ...
                                <div class="input-group short-input">
                                  ...
                                  <textarea class="form-control" rows="4" id="html-embed-code"><a href="{{url('aff')}}?ref={{ Sentinel::getuser()->ref_token }}"><img src="{{ url('/') }}/back/images/advertisement-1.jpg" alt="4NEW Signup Offer"/></a>
                                  </textarea>
                                </div>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="from-group">
                                ...
                                <div class="input-group short-input">
                                  ...
                                  <textarea class="form-control" rows="4" id="embed-code">[url={{url('aff')}}?ref={{ Sentinel::getuser()->ref_token }}][img]{{ url('/') }}/back/images/advertisement-1.jpg][/ur]</textarea>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div class="mt-3">
                  <div class="ref-code-container">
                    <a href="{{ url('/user-referral') }}"><img src="{{ url('/') }}/back/images/affiliate-banner.jpg"></a>
                    </div>
                </div>
            </div>
...
@endsection
    ...
    {
        var embedcode = document.getElementById("post-webinar-affiliate");
        //console.log(copyText);
        embedcode.select();
        document.execCommand("Copy");
    }
    ...
    <div class="modal-dialog video-pop">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <img src="{{ url('/') }}/back/images/mother1.jpg">
            <img src="{{ url('/') }}/back/images/poweredby.jpg">
            <img src="{{ url('/') }}/back/images/trashtotreasure.jpg">
          </div>
          </div>
        </div>
    </div>
