...
<div class="container-fluid">
    ...
    <div class="row justify-content-md-center">
        ...
        <div class="col-md-6">
          <div class='text-left'>
            <h5 class="mt-3">≈ <span class="coin_name">{{isset($latest_data->type)?$latest_data->type : ''}}</span> Amount</h5>  <div class='form-group'><div class='input-group'><input type='text' class='form-control' value="{{isset($latest_data->coin_amount)?$latest_data->coin_amount :''}}" id='post-shortlink22' readonly ><span class='input-group-btn'><button class='btn btn-primary btn-copy btn-sm' id='copy-button1' data-clipboard-target='#post-shortlink' type='button' onclick='copytext22()'>copy</button></span> </div></div><h5 class="mt-3">Send <span class="coin_name">{{isset($latest_data->type)? $latest_data->type : ''}}</span> To This Address</h5> <div class='form-group'><div class='input-group'><input type='text' class='form-control' value="{{isset($latest_data->address)?$latest_data->address : ''}}" id='post-shortlink11' readonly ><span class='input-group-btn'><button class='btn btn-primary btn-copy btn-sm' id='copy-button2' data-clipboard-target='#post-shortlink' type='button' onclick='copytext11()' >copy</button></span> </div></div>
          </div>
        ...
        <div class="col-md-6">
               ...
               <center>
                <img width='180px' class="mt-3" id="qr_code" src='{{isset($latest_data->qr_code)?$latest_data->qr_code : ''}}'>
              ...
              <div class="mt-2" id="pendingstatusbtn">
                  @if(isset($latest_data->status) && $latest_data->status==100)
...
<input type="hidden" name="" id="latestdata_total" value="{{$total_rows}}">
