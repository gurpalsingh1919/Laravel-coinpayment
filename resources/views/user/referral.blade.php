                      ...
                      <div class="card-body no-padding mt-4">
                        ...
                        <div class="col-md-5">
                          <div class="custom-refer-form">
                              <label class="reff-text"><i class="fas fa-user-alt"></i> No. of Referrals : <span>{{count($users)}}</span></label>
                              <label class="reff-text"><img src="{{ url('/') }}/back/images/kwatt.png"> Coins Earned: <span>{{$asTotal}}</span></label>
...
<small>
  <p>All times UTC<br/>
  <strong>Please note</strong>, the above mentioned bonus structure is in addition to the bonuses offered on the main website at 4new.io<br/>
  <strong>Purchaser Bonus</strong> will be earned by purchaser using the affiliate link<br/>
  <strong>Referral Bonus</strong> will be earned by the referrer sharing the referral link with purchasers.</p>
</small>
</div>
                  ...
                  <label>Image embed HTML:</label>
                    <div class="input-group short-input">
                        <div class="input-group-prepend">
                          <span class="input-group-text" data-clipboard-target="#html-embed-code"  onclick="copyhtmlembedd()"><i class="fas fa-copy"></i></span>
                        </div>
                        <textarea class="form-control" rows="4" id="html-embed-code"><a href="{{url('aff')}}?ref={{ Sentinel::getuser()->ref_token }}"> <img src="{{ url('/') }}/back/images/advertisement.jpg" alt="4NEW Signup Offer"/> </a></textarea>
                      </div>
              ...
              <div class="col-lg-6">
                <div class="from-group">
                  <label>Image embed HTML:</label>
                    <div class="input-group short-input">
                        <div class="input-group-prepend">
                          <span class="input-group-text" data-clipboard-target="#embed-code" onclick="copyhtmlembeddcode()"><i class="fas fa-copy"></i></span>
                        </div>
